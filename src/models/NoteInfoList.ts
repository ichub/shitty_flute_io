...
export class NoteInfoList {
    static readonly notes: INoteInfo[] = [
        ...
        makeINoteInfo(1, "Cs4", "Cs", NoteType.Flat, "/res/notes/one-lined/Cs-Normal.mp3", "/res/notes/one-lined/Cs-Shitty.mp3"),
        makeINoteInfo(2, "D4", "D", NoteType.Regular, "/res/notes/one-lined/D-Normal.mp3", "/res/notes/one-lined/D-Shitty.mp3"),
        makeINoteInfo(3, "Ds4", "Ds", NoteType.Flat, "/res/notes/one-lined/Ds-Normal.mp3", "/res/notes/one-lined/Ds-Shitty.mp3"),
        ...
        makeINoteInfo(6, "Fs4", "Fs", NoteType.Flat, "/res/notes/one-lined/Fs-Normal.mp3", "/res/notes/one-lined/Fs-Shitty.mp3"),
        makeINoteInfo(7, "G4", "G", NoteType.Regular, "/res/notes/one-lined/G-Normal.mp3", "/res/notes/one-lined/G-Shitty.mp3"),
        makeINoteInfo(8, "Gs4", "Gs", NoteType.Flat, "/res/notes/one-lined/Gs-Normal.mp3", "/res/notes/one-lined/Gs-Shitty.mp3"),
        makeINoteInfo(9, "A4", "A", NoteType.Regular, "/res/notes/one-lined/A-Normal.mp3", "/res/notes/one-lined/A-Shitty.mp3"),
        makeINoteInfo(10, "As4", "As", NoteType.Flat, "/res/notes/one-lined/As-Normal.mp3", "/res/notes/one-lined/As-Shitty.mp3"),
        ...
        makeINoteInfo(13, "Cs5", "Cs", NoteType.Flat, "/res/notes/two-lined/High-Cs-Normal.mp3", "/res/notes/two-lined/High-Cs-Shitty.mp3"),
        makeINoteInfo(14, "D5", "D", NoteType.Regular, "/res/notes/two-lined/High-D-Normal.mp3", "/res/notes/two-lined/High-D-Shitty.mp3"),
        makeINoteInfo(15, "Ds5", "Ds", NoteType.Flat, "/res/notes/two-lined/High-Ds-Normal.mp3", "/res/notes/two-lined/High-Ds-Shitty.mp3"),
